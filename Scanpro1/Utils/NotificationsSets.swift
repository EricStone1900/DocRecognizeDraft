...
class NewNotifications {
    ...
    struct DocumentChangeNoti: INewNotifioncation {
        typealias InfoType = ()
        static var name: String = "DocumentChange"
    }
    
    struct DocItemChangeNoti: INewNotifioncation {
        typealias InfoType = ()
        static var name: String = "DocItemChange"
    }
