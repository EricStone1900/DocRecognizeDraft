...
import UIKit
protocol VisualActivityDelegate: class {
...
@objcMembers final class VisualActivityViewController: UIActivityViewController {
    weak var delegate: VisualActivityDelegate?
    ...
    convenience init(images: [UIImage], activities: [UIActivity]? = nil) {
        self.init(activityItems: images, applicationActivities: activities)
    }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        delegate?.VisualActivityViewControllerWillDismiss()
    }
