//
//  SettingMenuTransitionAnimation.swift
//  Scanpro1
//
...
public protocol SettingMenu {
    
    var dismissButton: UIButton? { get }
    var titleLabel: UILabel? { get }
}

public protocol SettingMenuAnimationDelegate: class {
...
extension SettingMenuAnimationDelegate {
...
open class SettingMenuTransitionAnimation: NSObject {
    ...
    open weak var animationDelegate: SettingMenuAnimationDelegate?
    ...
    fileprivate func showHostTitleLabel(_ show: Bool, animated: Bool) {
        guard let guillotineMenu = menu as? SettingMenu else { return }
...
// MARK: - Animation
fileprivate extension SettingMenuTransitionAnimation {
    ...
    func animatePresentation(using context: UIViewControllerContextTransitioning) {
        ...
        if menu is SettingMenu {
            if supportView != nil && presentButton != nil {
                let guillotineMenu = menu as! SettingMenu
...
extension SettingMenuTransitionAnimation: UIViewControllerAnimatedTransitioning {
...
extension SettingMenuTransitionAnimation: UIDynamicAnimatorDelegate {
